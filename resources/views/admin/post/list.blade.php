                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <a href="admin/post/update/{{$post->posts_id}}" class="btn btn-info btn-sm">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa 
                                </a>
                            
                                <button data-id="{{$post->posts_id}}" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal-delete">
